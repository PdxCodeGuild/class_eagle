...
sister_x = random.randint(1,10)
sister_y = random.randint(1,10)
...
while game != "over":
    ...
    if int(sister_x) == int(player_x) and int(sister_y) == int(player_y):
        print ("You found her")
        game = "over"
