...
# Lab 4: Make Change
# Part 1 - Convert a dollar amount into a number of coins. The input will be the total 
...
print(f'Total number of Pennies: {total_pennies}')
